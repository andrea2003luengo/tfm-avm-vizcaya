...
medianas_photos = {
    ...
    "La Paz - El Carmen - Anunciación": 22.0, "La Unión - Vista Alegre": 16.0, "Sopelana": 24.0,
...
with st.form("formulario_tasacion"):
    ...
    with col1:
        ...
        # Mapeo condicional de distritos según el municipio
        distritos_por_muni = {
        ...
        # Mapeo condicional de barrios según el distrito
    ...
    # Botón interno del formulario streamlit
